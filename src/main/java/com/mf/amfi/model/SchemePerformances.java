...
public class SchemePerformances {
	...
	@Transient
	private String inception_date_str;
	...
	@Transient
	public String getInception_date_str() {
		return inception_date_str;
	}
	@Transient
	public void setInception_date_str(String inception_date_str) {
		this.inception_date_str = inception_date_str;
	}
}
