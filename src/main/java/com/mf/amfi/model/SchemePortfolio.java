...
public class SchemePortfolio
{
	...
	public String getAsset_class_eq() {
		return asset_class_eq;
	}
	public void setAsset_class_eq(String asset_class_eq) {
		this.asset_class_eq = asset_class_eq;
	}
	public String getRating_eq() {
		return rating_eq;
	}
	public void setRating_eq(String rating_eq) {
		this.rating_eq = rating_eq;
	}	
}
