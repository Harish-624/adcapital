...
public class BenchmarkSIPCalcFinalResponse 
{
    ...
    public List<BenchmarkSIPCalcResponse> sip_list;
    public String url;
	...
	public List<BenchmarkSIPCalcResponse> getSip_list() {
		return sip_list;
	}
	public void setSip_list(List<BenchmarkSIPCalcResponse> sip_list) {
