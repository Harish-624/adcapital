...
public class SWPReturnsCalculatorAPIResponse {
	...
	public List<Double> cumulative_withdrawal;
	public List<Double> current_value_graph;
	...
	public List<Double> getCumulative_withdrawal() {
		return cumulative_withdrawal;
	}
	public void setCumulative_withdrawal(List<Double> cumulative_withdrawal) {
		this.cumulative_withdrawal = cumulative_withdrawal;
	}
	public List<Double> getCurrent_value_graph() {
		return current_value_graph;
	}
	public void setCurrent_value_graph(List<Double> current_value_graph) {
		this.current_value_graph = current_value_graph;
	}	
}