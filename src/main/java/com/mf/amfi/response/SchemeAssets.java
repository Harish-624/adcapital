...
public class SchemeAssets {
	...
	public void setAsset_north_american_equities(double asset_north_american_equities) {
	...
	public void setAsset_global_emerging_market_equities(double asset_global_emerging_market_equities) {
	...
	public void setAsset_international_equitites(double asset_international_equitites) {
	...
	public void setAsset_net_current_liabilities(double asset_net_current_liabilities) {
