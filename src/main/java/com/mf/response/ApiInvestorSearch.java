...
public class ApiInvestorSearch {
	...
	public String getBse_nse_code() {
		return bse_nse_code;
	}
	public void setBse_nse_code(String bse_nse_code) {
		this.bse_nse_code = bse_nse_code;
	}
