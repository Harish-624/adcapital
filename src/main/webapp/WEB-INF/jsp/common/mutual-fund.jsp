    ...
    <div class="row align-items-center mb-5 pb-4 sr-section no-reverse">
      <div class="col-lg-5" style="margin-top: -20px;">
        <div class="about-image-stack sr-child">
          ...
          <img src="/images/services/mutual_fund.webp" class="img-fluid" alt="Mutual Funds" loading="lazy">
        </div>
      </div>
      <div class="col-lg-7">
    ...
    <div class="row mb-3 sr-section">
      <div class="col-lg-10 mx-auto">
        ...
        <div class="sr-child text-center mt-4">
          <img src="/images/services/Taxation_Mutual_fund.jpeg" class="img-fluid rounded-4 shadow-lg" alt="Taxation of Mutual Funds" style="width: 100%; border: 1px solid rgba(0,0,0,0.05);" loading="lazy">
        </div>
      </div>
    </div>
